            ...
            {currentStatement && (
              ...
              <div className="m-4 p-6 border-solid rounded border">
                ...
                <div className="flex felx-wrap justify-around">
                        ...
                        <button className="bg-gray-500 py-2 px-4 hover:bg-gray-400 rounded border border-transparent rounded shadow-sm text-sm font-medium text-white" value="pass" onClick={handleVote}>
                        Pass
                        </button>
                        <button className="bg-red-500 py-2 px-4 hover:bg-red-400 rounded border border-transparent rounded shadow-sm text-sm font-medium text-white" value="disagree" onClick={handleVote}>
                        Disagree
                        </button>
                    </div>
                  </div>
