  ...
  return (
    <div
      className={`absolute flex flex-col p-6 space-y-20 bg-white my-1/20 mx-auto ${
        isMobile
          ? "top-1/20 left-1/20 w-4/5 min-w-300px h-auto"
    ...
    >
      <div className="flex flex-col space-y-4">
        <div className="flex flex-wrap justify-between">
          ...
          {!isMobile && isOverlay && (
            <button
              className="bg-red-500 h-30px w-30px px-1 bg-opacity-90 hover:bg-opacity-70 rounded border border-transparent rounded shadow-sm text-sm font-medium text-white"
